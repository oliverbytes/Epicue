    ...
    Container {
        ...
        Container {
            ...
            ContactInfoButton 
            {
                ...
                text: (thedata.telnum != "" ? thedata.telnum : "none")
                onTouch: 
                {
                    if (event.isDown()) 
                    {
                ...
                contextActions: [
                    ActionSet {
                        title: (thedata.name != "" ? thedata.name : "none")
                        subtitle: "Phone: " + (thedata.telnum != "" ? thedata.telnum : "none")
                        ActionItem {
                            title: "Call"
            ...
            ContactInfoButton {
                ...
                text: (thedata.email != "" ? thedata.email : "none")
                onTouch: 
                {
                    if (event.isDown()) 
                    {
            ...
            ContactInfoButton {
                ...
                text: (thedata.website != "" ? thedata.website : "none")
                onTouch: 
                {
                    if (event.isDown()) 
                    {
                ...
                contextActions: [
                    ActionSet {
                        title: (thedata.name != "" ? thedata.name : "none")
                        subtitle: "Website: " + (thedata.website != "" ? thedata.website : "none")
                        ActionItem {
        ...
        Container {
            ...
            ContactSocialInfoButton {
                id: facebookButton
                type: "facebook"
                text: (thedata.facebookid != "" ? thedata.facebookid : "none")
                onTouch: 
                {
                    if (event.isDown()) 
                    {
            ...
            ContactSocialInfoButton {
                type: "twitter"
                text: (thedata.twitterid != "" ? "@" + thedata.twitterid : "none")
                onTouch: 
                {
                    if (event.isDown()) 
                    {
